 ...
 *
 */
public class E_FuncDBP_YEAR extends DBPedia_Function {

	/**
	 * default constructor
	 */
	public E_FuncDBP_YEAR() {
	}
	
	/**
	 * constructor
	 */
	public E_FuncDBP_YEAR(XLExpr arg) {
		addArg(arg);
	}
	...
	public XLExprValue<?> eval(ExecutionContext context) throws XLWrapException, XLWrapEOFException {
		...
		return dbpediaURI(TypeCast.toString(v1.eval(context)));
	}
