 ...
 *
 */
public class E_LogicalNot extends XLExpr1 {

	/**
	 * constructor
	 */
	public E_LogicalNot(XLExpr arg) {
		super(arg);
	}
	...
	@Override
	public XLExpr copy() {
		return new E_LogicalNot(arg.copy());
	}
	...
	public XLExprValue<?> eval(ExecutionContext context) throws XLWrapException, XLWrapEOFException {
		...
		return TypeCast.toBoolean(val, context) ? E_Boolean.FALSE : E_Boolean.TRUE; // reverse
	}
