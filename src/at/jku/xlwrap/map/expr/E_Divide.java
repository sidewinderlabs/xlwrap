 ...
 *
 */
public class E_Divide extends XLExpr2 {

	/**
	 * constructor
	 */
	public E_Divide(XLExpr arg1, XLExpr arg2) {
		super(arg1, arg2);
	}
	...
	public XLExprValue<?> eval(ExecutionContext context) throws XLWrapException, XLWrapEOFException {
		...
		return TypeCast.toExprNumber(v1).divide(TypeCast.toExprNumber(v2));
	}

	@Override
	public XLExpr copy() {
		return new E_Divide(arg1.copy(), arg2.copy());
	}
