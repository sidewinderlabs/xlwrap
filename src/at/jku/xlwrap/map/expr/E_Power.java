 ...
 *
 */
public class E_Power extends XLExpr2 {

	/**
	 * constructor
	 */
	public E_Power(XLExpr arg1, XLExpr arg2) {
		super(arg1, arg2);
	}
	...
	public XLExprValue<?> eval(ExecutionContext context) throws XLWrapException, XLWrapEOFException {
		...
		return TypeCast.toExprNumber(v1).power(TypeCast.toExprNumber(v2));
	}

	@Override
	public XLExpr copy() {
		return new E_Power(arg1.copy(), arg2.copy());
	}
