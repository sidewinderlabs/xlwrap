 ...
 *
 */
public class TestCSVWorkbookLoading {

	static {
		XLWrapTestCase.TEST_FILE_DATA1 = "testing/test-data1.csv";
	}
	
	@Test
	public void testCSVLoading() throws XLWrapException, XLWrapEOFException {
		Workbook wb = WorkbookFactory.getWorkbook(XLWrapTestCase.TEST_FILE_DATA1_CSV);
